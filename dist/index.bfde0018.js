...
})({"lPhdK":[function(require,module,exports) {
...
const edge = (n)=>n === 0;
const rightEdge = (n)=>n === mapWidth - 1;
const bottomEdge = (n)=>n === mapHeight - 1;
const indestructibleBlock = (x, y)=>x % 2 === 0 && y % 2 === 0;
for(let y = 0; y < gameMap.length; y++){
    for(let x = 0; x < gameMap[y].length; x++)if (edge(x) || edge(y) || rightEdge(x) || bottomEdge(y) || indestructibleBlock(x, y)) gameMap[y][x] = 1;
}
...
for (const [x, y] of corners)gameMap[y][x] = 5;
...
for (const [x, y] of corners)gameMap[y][x] = 0;
// Now, gameMap represents your randomized game map with the rules you specified.
const grid = (0, _miniFramework.createDOMElement)("div", {
    class: "game-map"
}, []);
for(let y = 0; y < gameMap.length; y++)for(let x = 0; x < gameMap[y].length; x++){
    ...
    switch(gameMap[y][x]){
        case 1:
            cell = (0, _miniFramework.createDOMElement)("div", {
                class: "w-[60px] h-[60px] bg-[#D9D9D9] border-2 border-solid border-black"
            }, []);
        ...
        case 2:
            cell = (0, _miniFramework.createDOMElement)("div", {
                ...
                (0, _miniFramework.createDOMElement)("img", {
                    src: "https://cdn.discordapp.com/attachments/1075493710692876330/1165626018829172859/destructible-wall.png?ex=654788d3&is=653513d3&hm=a18178a7ad7cefb56d34d5cb28854fdf275651c1fb3315cb6c13287232eaf89f&",
                    alt: ""
                }, [])
            ]);
            grid.element.appendChild(cell.element);
        ...
        default:
            cell = (0, _miniFramework.createDOMElement)("div", {
                class: "w-[60px] h-[60px] bg-lime-800",
                id: `cell-${x}-${y}`
            }, []);
            grid.element.appendChild(cell.element);
            break;
...
},{"mini-framework":"9Vprj"}],"9Vprj":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lPhdK","f3qN5"], "f3qN5", "parcelRequiree395")
