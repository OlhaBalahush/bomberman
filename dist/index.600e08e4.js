...
})({"bUSOZ":[function(require,module,exports) {
...
const r = new (0, _miniFramework.Router);
r.addRoute("/waiting-room", ()=>{
    console.log("wait");
    window.location.href = "/waiting-room";
});
// r.navigateTo("/waiting-room")
const input = (0, _miniFramework.useStateManager)("");
...
document.body.appendChild(startPage.element);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bUSOZ","kgSFy"], "kgSFy", "parcelRequiree395")
